    ...
    <div className="container mx-auto py-8">
      <Link href="/blog">
        <div className="fixed flex items-center">
          <p className="hover:cursor-pointer hover:text-[#0bad4c]">
            <IoArrowBackSharp size={30} />
          </p>
        </div>
      </Link>
      <div className="mb-6 flex items-center justify-center">
        <div className="mt-auto flex items-center rounded bg-[#0bad4c] px-4 py-1 text-white">
          <p className="text-sm font-semibold">{blog.category}</p>
        </div>
      </div>
      <h1 className="mb-4 text-center text-4xl font-bold">{blog.title}</h1>
      <p className="text-center text-sm">
        <span className="hover:cursor-pointer hover:text-[#0bad4c]">
          {blog.reference}
        </span>{' '}
